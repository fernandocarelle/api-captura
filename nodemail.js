...
module.exports = (email, nome, telefone, anexo) => {
    ...
    const mail = {
        ...
        <body class="">
          <span class="preheader">Você ganhou um cupom de desconto do salão Diva's.</span>
                      ...
                      <td class="wrapper">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td>
                              <p>Olá, ${nome}</p>
                              <p>Parabéns!! Você ganhou um cupom de desconto. Agende seu horário clicando no botão abaixo e nos envie um print do seu cupom de desconto.</p>
                                  ...
                                  <tr>
                                    <td align="left">
                                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                        <tbody>
                                          <tr>
                                            <td> <a href="http://bit.ly/cupomdivas" target="_blank">Agende aqui</a> </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </td>
                              ...
                              <img src="https://i.ibb.co/2nQHyj6/GANHOU-1.png" width="100%" alt="cupom" id="cupom" />
                              <p id="pLogo">
    ...
    const mail2 = {
        ...
        replyTo: email,
        subject: `${nome} Preencheu o formulário de desconto.`,
        /* text: mensagem, */
        html: `<!doctype html>
        <html>
          <head>
          ...
          <body class="">
            <span class="preheader"> ${nome} preencheu o formulário de desconto</span>
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body">
              <tr>
                <td>&nbsp;</td>
                <td class="container">
                        ...
                        <td class="wrapper">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td>
                                <p>Olá, Diva's</p>
                                <p><b>${nome}</b> preencheu o formulário de desconto</p>
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" >
                                  <tbody>
                                    <tr>
                                      <td >
